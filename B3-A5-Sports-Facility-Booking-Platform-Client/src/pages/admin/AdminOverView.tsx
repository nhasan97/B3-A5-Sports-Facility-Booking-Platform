...
const AdminOverView = () => {
  ...
  const { loadingBookings, numberOfTotalBookings } =
  ...
  return (
    <div className="h-screen">
      <DashboardContainer>
        ...
        {isLoading || loadingNumberOfFacilities || loadingBookings ? (
          <Loading />
        ) : (
          <div className="w-full h-full space-y-6 overflow-y-auto">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              <div className="w-full bg-[#181717] p-6 space-y-4 rounded-lg">
                ...
                <Link to="/admin-dashboard/admin-dashboard-facilities">
                  <Button>View Facilities</Button>
                </Link>
              </div>
              <div className="w-full bg-[#181717] p-6 space-y-4 rounded-lg">
                <h2 className="text-[#757575] text-3xl">Total Bookings</h2>
                <p className="text-[#d4d4d4] text-7xl">
                  {numberOfTotalBookings}
                </p>
                <Link to="/admin-dashboard/admin-dashboard-bookings">
